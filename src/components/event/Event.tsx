...
const Event: FC = () => {
	...
	return (
		<div className='home-container w-full bg-alternative lg:w-9/12'>
			...
			<div className='-mt-8 relative z-10 lg:-mt-0 lg:pt-32 lg:z-0'>
				<div className='px-8'>
					<p className='flex justify-between items-center text-white lg:text-black'>
						<span>1.2.2020</span>
						<span>20:00</span>
					</p>
					<h1 className='font-semibold mb-8 mt-4 text-5xl text-primary leading-12 lg:leading-13 lg:text-6xl lg:w-custom2'>Party with Eminem</h1>
					<p className='pb-10 lg:w-custom3 xl:w-custom2 flex justify-between items-center'>
				...
				<div className='bg-white px-8 pt-8 pb-20 lg:bg-transparent'>
					...
					<p className='mb-12 lg:w-custom2'>Aliquet sed iaculis posuere egestas integer. Lectus morbi lectus consequat, massa etiam a sed in. Sollicitudin id dignissim tincidunt ipsum vel morbi diam  ultricies fermentum. Aliquet sed iaculis posuere egestas integer. Lectus morbi lectus consequat, massa etiam a sed in. Sollicitudin id dignissim tincidunt ipsum vel morbi diam  ultricies fermentum.</p>
