		...
		<div className='search-container'>
			<div className='bg-background-search h-500 lg:h-650 bg-no-repeat bg-cover flex justify-center items-center'>
				<div className='max-w-6xl w-full px-8'>
					<p className='uppercase font-semibold my-6'>Featured events</p>
					<h1 className='font-semibold mt-4 text-5xl text-primary leading-12 lg:leading-13 lg:text-6xl lg:w-custom2 mb-12 lg:mb-28'>What is next?</h1>
			...
			<div className='w-full px-8'>
				<h2 className='font-normal text-2xl my-6'>Featured events</h2>
				<SliderCard />
